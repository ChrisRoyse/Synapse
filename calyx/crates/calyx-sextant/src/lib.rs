...
pub use error::{
    ...
    CALYX_SEXTANT_PROVENANCE_SHAPE_UNREGISTERED, CALYX_SEXTANT_PROVENANCE_SUBJECT_UNRESOLVED,
    CALYX_SEXTANT_QUERY_SHAPE, CALYX_SEXTANT_RECURRENCE_READ_ERROR,
    CALYX_SEXTANT_RERANKER_ENDPOINT, CALYX_SEXTANT_RERANKER_NO_CANDIDATES,
    CALYX_SEXTANT_RERANKER_PROTOCOL, CALYX_SEXTANT_RERANKER_TIMEOUT,
    CALYX_SEXTANT_SKILL_BUDGET_EXCEEDED, CALYX_SEXTANT_SKILL_PAIR_NO_OVERLAP,
    CALYX_SEXTANT_SKILL_PARAMS, CALYX_SEXTANT_SKILL_UNKNOWN, CALYX_SEXTANT_SLOT_ALREADY_REGISTERED,
    CALYX_SEXTANT_SLOT_INACTIVE, CALYX_SEXTANT_SLOT_MISSING, CALYX_SEXTANT_TRAVERSE_HOPS,
    CALYX_SEXTANT_VECTOR_FUSION_UNWIRED, CALYX_SEXTANT_VECTOR_SHAPE, CALYX_TEMPORAL_AP60_VIOLATION,
