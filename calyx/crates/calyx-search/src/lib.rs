...
pub use engine::{
    ...
    ReconciledPanelMembership, SearchBudget, SearchFreshness, SearchOutcome, SearchSlotCache,
    SearchSlotCacheDiagnostic, SearchTraceEvent, measure_exact_value, measure_panel_delta,
    measure_query, measure_query_vectors, measure_query_vectors_with_slots,
    reconcile_panel_membership, search_outcome, search_outcome_with_freshness,
...
pub use persisted::{
    ...
    PersistedDenseQuantization, PersistedPanelMembership, PersistedSearchGeneration,
    PersistedSearchIndexes, PersistedSearchManifestArtifact, PersistedSearchSlot,
    ...
    manifest_path, publish_live_manifest_artifact, read_candidate_manifest_artifact,
    read_live_manifest_artifact, read_rebuild_required_marker,
