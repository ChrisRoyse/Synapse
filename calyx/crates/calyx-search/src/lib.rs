...
pub use engine::{
    ...
    measure_exact_value, measure_panel_delta, measure_query, measure_query_vectors,
...
pub use persisted::{
    MarkerClearOutcome, PersistedDenseIndexConfig, PersistedSearchGeneration,
    PersistedSearchIndexes, PersistedSearchSlot, REBUILD_REQUIRED_REMEDIATION,
    REBUILD_REQUIRED_SCHEMA, RebuildProgress, RebuildRequiredMarker, clear_rebuild_required_marker,
    clear_rebuild_required_marker_if_owned, load_docs, manifest_path, read_rebuild_required_marker,
