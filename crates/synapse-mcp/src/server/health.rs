...
fn apply_storage_maintenance_fields(
    ...
    health.storage_pressure_last_total_bytes = readback.pressure_probe.last_total_bytes;
    ...
    health.storage_gc_last_successful_source_census_mode =
        readback.gc_task.last_successful_source_census_mode.clone();
    health.storage_gc_last_successful_source_census_previous_pinned_seq = readback
        .gc_task
        .last_successful_source_census_previous_pinned_seq;
    ...
    health.storage_gc_last_successful_source_census_changed_base_keys = readback
        .gc_task
        .last_successful_source_census_changed_base_keys;
    health.storage_gc_last_successful_source_census_rebase_reason = readback
        .gc_task
        .last_successful_source_census_rebase_reason
        .clone();
    ...
    fn calyx_vault_health(&self) -> SubsystemHealth {
        ...
        SubsystemHealth {
            ...
            detail: Some(format!(
                ...
                status.retained_lookup_files,
                status.retained_lookup_entries,
                status.retained_lookup_estimated_heap_bytes,
                status
                    .vault_dir
                    .as_ref()
            ...
            calyx_retained_lookup_files: status.retained_lookup_files,
            calyx_retained_lookup_entries: status.retained_lookup_entries,
            calyx_retained_lookup_estimated_heap_bytes: status
