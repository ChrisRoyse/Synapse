...
pub use registry::{
    ...
    WHISPER_TINY_INT8_ONNX_FILENAME, WHISPER_TINY_INT8_ONNX_ID, WHISPER_TINY_INT8_ONNX_SHA256,
    default_detection_model, default_detection_model_descriptor, lightweight_cpu_detection_model,
    registered_model,
};
pub use session::{
