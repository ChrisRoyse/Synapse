...
pub use registry::{
    ...
    EmbeddedModelBundle, EmbeddedModelSlot, REGISTERED_MODELS, RTDETR_V2_S_COCO_INT8_ONNX,
    RTDETR_V2_S_COCO_INT8_ONNX_DOWNLOAD_URL, RTDETR_V2_S_COCO_INT8_ONNX_FILENAME,
    RTDETR_V2_S_COCO_INT8_ONNX_ID, RTDETR_V2_S_COCO_INT8_ONNX_SHA256, RTDETR_V2_S_COCO_ONNX,
    RTDETR_V2_S_COCO_ONNX_DOWNLOAD_URL, RTDETR_V2_S_COCO_ONNX_FILENAME, RTDETR_V2_S_COCO_ONNX_ID,
    RTDETR_V2_S_COCO_ONNX_LICENSE, RTDETR_V2_S_COCO_ONNX_SHA256,
    RTDETR_V2_S_COCO_ONNX_SOURCE_MODEL, RTDETR_V2_S_COCO_ONNX_SOURCE_REPO, RegisteredModel,
    WHISPER_TINY_INT8_ONNX, WHISPER_TINY_INT8_ONNX_FILENAME, WHISPER_TINY_INT8_ONNX_ID,
