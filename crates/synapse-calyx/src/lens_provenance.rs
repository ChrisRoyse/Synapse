...
pub const SYN_SLOT_SOURCE_FIELDS: &[(u16, u32, &str, &[&str])] = &[
    ...
    (23, 1983001, "syn.agent_event.kind_onehot.v1", &["kind"]),
    (
        24,
        1983001,
    ...
    (31, 1983001, "syn.agent_event.hour_cyclic.v1", &["ts_ns"]),
    (32, 1983001, "syn.agent_event.dow_cyclic.v1", &["ts_ns"]),
    (
        33,
        1983001,
